...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h1 class="h2 fs-16 mb-0">Rent Order Details</h1>
            <a class="btn btn-info"
                href="{{ Session::has('last_url') ? Session::get('last_url') : route('rent.cancel_requests.index') }}">Go Back</a>
        </div>
        <div class="card-body">
                    ...
                    <table class="float-right">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">{{ $order->order_date->format('d-m-Y h:i A') }}</td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            @if ($order)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($order->product != null)
                                            <strong class="text-muted">{{ $order->product->name }}</strong>
                                            {{-- <small> --}}
