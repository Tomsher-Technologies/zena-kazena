                ...
                <tbody>
                    @foreach ($orders as $key => $order)
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('rent.cancel_orders.show', encrypt($order->id))}}" title="View">
    ...
    <script type="text/javascript">
        $(document).on("click", ".adminApprove", function(e) {
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        url: "{{ route('rent.cancel-request-status') }}",
                        type: "POST",
                        data: {
                            id: id,
                            status:status,
