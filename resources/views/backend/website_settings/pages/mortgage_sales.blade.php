    ...
    <div class="card">
        ...
        <form class="p-4" action="{{ route('custom-pages.update', $page->id) }}" method="POST"
            ...
            <div class="card-body px-0">
                ...
                <div class="form-group row ">
                    <label class="col-md-2 col-form-label" for="signinSrEmail">{{ trans('messages.image') }} 1</label>
                    <div class="col-md-10">
                        <input type="file" name="image1" class="form-control" accept="image/*">

                        @if ($page->getTranslation('image1', $lang))
                            <div class="file-preview box sm">
                                <div  class="d-flex justify-content-between align-items-center mt-2 file-preview-item">
                                    <div
                                        ...
                                        <img src="{{ asset($page->getTranslation('image1', $lang)) }}" class="img-fit">
                                    </div>
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-from-label" for="name">{{ trans('messages.heading') }} 1<span
                            class="text-danger">*</span> </label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row ">
                    <label class="col-md-2 col-form-label" for="signinSrEmail">{{ trans('messages.image') }} 2</label>
                    <div class="col-md-10">
                        <input type="file" name="image2" class="form-control" accept="image/*">

                        @if ($page->getTranslation('image2', $lang))
                            <div class="file-preview box sm">
                                <div  class="d-flex justify-content-between align-items-center mt-2 file-preview-item">
                                    <div
                                        class="align-items-center align-self-stretch d-flex justify-content-center thumb">
                                        <img src="{{ asset($page->getTranslation('image2', $lang)) }}" class="img-fit">
                                    </div>
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-from-label" for="name">{{ trans('messages.heading') }} 2<span
                            class="text-danger">*</span> </label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-from-label" for="name">{{ trans('messages.content') }} 2<span
                            class="text-danger">*</span></label>
                    <div class="col-sm-10">
                        <textarea  class="aiz-text-editor form-control" placeholder="{{ trans('messages.content') }}"
                            data-buttons='[["font", ["bold", "underline", "italic", "clear"]],["para", ["ul", "ol", "paragraph"]],["style", ["style"]],["color", ["color"]],["table", ["table"]],["insert", ["link", "picture", "video"]],["view", ["fullscreen", "codeview", "undo", "redo"]]]'
