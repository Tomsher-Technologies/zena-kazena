                    ...
                    <div class="add-product-form d-flex gap-5">
                        ...
                        <div class="flex-grow-1">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="unit" name="unit"
                                            placeholder="{{ trans('messages.unit_details') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="min-qty">{{ trans('messages.minimum_purchase_qty') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="number" id="min-qty" name="min-qty" value="1"
                            ...
                            <div class=" mb-5 form-section">
                                ...
                                <div class="form-group">
                                    <label
                                        for="date-range">{{ trans('messages.discount') . ' ' . trans('messages.date') . ' ' . trans('messages.range') }}</label>
                                ...
                                <div data-repeater-list="products">
                                    ...
                                    <div data-repeater-item>
                                        <div class="product-variant">
                                            ...
                                            <div class="form-group imageVariant">
                                                <label
                                                ...
                                                <input class="product-variant-image-input" type="file"
                                                    id="product-variant-image" name="product-variant-image"
                                                    accept="image/*">
                                            </div>
                                ...
                                <div data-repeater-list="tabs">
                                    <div data-repeater-item>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="tab_heading" placeholder="Enter heading">
                                        </div>
                                        <div class="form-group">
                                            <label for="rich-text-editor">{{ trans('messages.description') }}</label>
                                            <textarea class="text-editor w-100 p-3" id="rich-text-editor" placeholder="Enter description" name="tab_description"></textarea>
                                        </div>
                                        <div class="form-group row justify-content-end">
                                            <input data-repeater-delete type="button" style="width:auto;"class="btn btn-danger btn-sm delete-btn action-btn" value="{{ trans('messages.delete') }}">
                                        </div>
                                    </div>
                                </div>
                            
                                <input data-repeater-create type="button" style="width:auto;"class="btn btn-success action-btn mt-0" value="{{ trans('messages.add') }}">
                            </div>
...
@section('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const variantHeading = document.getElementById("pro_variant_name");
            ...
            productType.addEventListener("change", function() {
                if (this.value === "variant") {
                    ...
                    attributesSelect.disabled = false; // Enable the attributes select
                    variantHeading.style.display = "block";
                } else {
                    attributesSection.style.display = "none";
                    attributesSelect.disabled = true; // Disable the attributes select
                    variantHeading.style.display = "none";
                }
            });
            ...
            attributesSelect.addEventListener("change", function() {
                ...
                selectedAttributes.forEach(attributeId => {
                    ...
                    fetch(`/vendor/get-attribute-values/${attributeId}`)
                        ...
                        .then(data => {
                            // Create a new product_attributes section
