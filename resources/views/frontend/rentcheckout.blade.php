                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="checkout__container">
                            ...
                            <!-- End row -->
                            <form id="checkoutForm" action="{{ route('rent.checkout.process') }}" method="POST">
                                @csrf
                                <!-- Billing form -->
                                <div class="billing-form">
                                    ...
                                    <div class="form-group">
                                        <input type="text" placeholder="{{ trans('messages.full_name') }} *"
                                            id="billing_name" name="billing_name" class="form-group__input"
                                    ...
                                    <div class="form-group">
                                        <input type="text" placeholder="{{ trans('messages.address') }} *"
                                            id="billing_address" name="billing_address" class="form-group__input"
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="billing_city" name="billing_city"
                                            placeholder="{{ trans('messages.town_city') }} *" class="form-group__input"
                                    ...
                                    <div class="form-group">
                                        <input type="text" placeholder="{{ trans('messages.zip') }} *"
                                            id="billing_zipcode" name="billing_zipcode" class="form-group__input"
                                    ...
                                    <div class="form-group">
                                        <input type="text" placeholder="{{ trans('messages.phone') }} *"
                                            id="billing_phone" name="billing_phone" class="form-group__input"
                                    ...
                                    <div class="form-checkbox">
                                        <input type="checkbox" id="checkbox2" name="same_as_billing"
                                            class="form-checkbox__input" @if (old('same_as_billing') == 'on') checked @endif />
                                        <label class="form-checkbox__label"
                                            for="checkbox2">{{ trans('messages.same_shipping') }}</label>
                                    </div>
                                    <!-- End form checkbox -->
                                    ...
                                    <div class="shipping-address">
                                        ...
                                        <div class="form-group">
                                            <input type="text" placeholder="{{ trans('messages.full_name') }} *"
                                                id="shipping_name" name="shipping_name" class="form-group__input"
                                                value="{{ old('shipping_name') }}"
                                                @if (old('same_as_billing') == 'on') readonly @endif>
                                        </div>

                                        <div class="form-group">
                                            <input type="text" placeholder="{{ trans('messages.address') }} *"
                                                id="shipping_address" name="shipping_address" class="form-group__input"
                                        ...
                                        <div class="form-group">
                                            <input type="text" placeholder="{{ trans('messages.zip') }} *"
                                                id="shipping_zipcode" name="shipping_zipcode" class="form-group__input"
                                        ...
                                        <div class="form-group">
                                            <input type="text" placeholder="{{ trans('messages.phone') }} *"
                                                id="shipping_phone" name="shipping_phone" class="form-group__input"
                                    ...
                                    <!-- Form group -->
                                    <div class="form-group">
                                        <textarea placeholder="{{ trans('messages.order_note') }}" name="order_note" class="form-group__textarea"
                                            rows="5"></textarea>
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="checkout__summary">
                            <!-- Title --->
                            <h3 class="checkout-summary__title">{{ trans('messages.your') . ' ' . trans('messages.order') }}
                            </h3>
                            <!-- End title -->
                            <!-- Products -->
                                ...
                                @if ($product)
                                    ...
                                    <div class="checkout__product">
                                        <div class="checkout-product__image">
                                            <a
                                                href="{{ route('rent.product-detail', ['slug' => $product['slug'], 'sku' => $product['sku']]) }}">
                                        ...
                                        <div class="checkout-product__title-and-variant">
                                            <h3 class="checkout-product__title"><a
                                                    href="{{ route('rent.product-detail', ['slug' => $product['slug'], 'sku' => $product['sku']]) }}">{{ $product['name'] }}</a>
                                            </h3>
                                        ...
                                        <div class="checkout-product__price">{{ $order['quantity'] }} x
                                            {{ env('DEFAULT_CURRENCY') }} {{ $product['price'] }}
                                            ({{ $order['no_of_days'] }} {{ $order['no_of_days'] == 1 ? 'day' : 'days' }})
                                        </div>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="checkout__subtotal-and-shipping">
                                ...
                                <div class="checkout__subtotal">
                                    <div class="checkout-subtotal__title">{{ trans('messages.sub_total') }}</div>
                                    <div class="checkout-subtotal__price">{{ env('DEFAULT_CURRENCY') }}
                                        {{ $order['sub_total'] }}</div>
                                </div>
                                <!-- End subtotal -->

                                <div class="order-summary__subtotal">
                                    <div class="summary-subtotal__title">{{ trans('messages.deposit') }}</div>
                                    <div class="summary-subtotal__price">{{ env('DEFAULT_CURRENCY') }}
                                        {{ intval($order->deposit) }}</div>
                                </div>
                                <div class="order-summary__subtotal">
                                ...
                                {{-- <div class="order-summary__subtotal">
                                    ...
                                    <div class="summary-subtotal__price">{{ env('DEFAULT_CURRENCY') }} {{ $order['discount'] }}</div>
                                </div> --}}
                            ...
                            <div class="checkout__total">
                                ...
                                <div class="checkout-total__price">{{ env('DEFAULT_CURRENCY') }}
                                    {{ $order['grand_total'] }}</div>
                            </div>
                            <!-- End total -->
                            <!-- Payment methods -->
                            ...
                            <div class="checkout__privacy-policy">
                                {{ trans('messages.checkout_msg') }} <a
                                    href="#">{{ trans('messages.privacy_policy') }}</a>.
                            </div>
                            <!-- End privacy policy -->
                            <!-- Action -->
                            <div class="checkout__action">
                                <button type="button" id="submitCheckout"
                                    class="second-button">{{ trans('messages.place_order') }}</button>
                            </div>
                            <!-- End action -->
                        </div>
                        <!-- End summary -->
